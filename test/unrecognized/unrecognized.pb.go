...
func (m *A) Unmarshal(data []byte) error {
    ...
    for index < l {
        ...
        case 1:
            if wireType != 2 {
                return fmt1.Errorf("proto: wrong wireType = %d for field B", wireType)
            }
            var msglen int
            for shift := uint(0); ; shift += 7 {
                if index >= l {
        ...
        default:
            ...
            index -= sizeOfWire
            skippy, err := dropbox_gogoprotobuf_proto3.Skip(data[index:])
            if err != nil {
                return err
            }
            if (index + skippy) > l {
...
func (m *B) Unmarshal(data []byte) error {
    ...
    for index < l {
        ...
        case 1:
            if wireType != 2 {
                return fmt1.Errorf("proto: wrong wireType = %d for field C", wireType)
            }
            var msglen int
            for shift := uint(0); ; shift += 7 {
                if index >= l {
        ...
        case 2:
            if wireType != 2 {
                return fmt1.Errorf("proto: wrong wireType = %d for field D", wireType)
            }
            var msglen int
            for shift := uint(0); ; shift += 7 {
                if index >= l {
        ...
        case 5:
            if wireType != 2 {
                return fmt1.Errorf("proto: wrong wireType = %d for field F", wireType)
            }
            var msglen int
            for shift := uint(0); ; shift += 7 {
                if index >= l {
...
func (this *A) String() string {
    ...
    s := strings.Join([]string{`&A{`,
        ...
        `B:` + strings.Replace(fmt2.Sprintf("%v", this.B), "B", "B", 1) + `,`,
...
func (this *B) String() string {
    ...
    s := strings.Join([]string{`&B{`,
        `C:` + strings.Replace(fmt2.Sprintf("%v", this.C), "C", "C", 1) + `,`,
        `D:` + strings.Replace(fmt2.Sprintf("%v", this.D), "D", "D", 1) + `,`,
        `F:` + strings.Replace(fmt2.Sprintf("%v", this.F), "OldC", "OldC", 1) + `,`,
        `XXX_unrecognized:` + fmt2.Sprintf("%v", this.XXX_unrecognized) + `,`,
        `}`,
    }, "")
    return s
...
func (this *OldA) String() string {
    ...
    s := strings.Join([]string{`&OldA{`,
        `Field1:` + valueToStringUnrecognized(this.Field1) + `,`,
        `B:` + strings.Replace(fmt2.Sprintf("%v", this.B), "OldB", "OldB", 1) + `,`,
        `XXX_unrecognized:` + fmt2.Sprintf("%v", this.XXX_unrecognized) + `,`,
        `}`,
    }, "")
    return s
...
func (this *OldB) String() string {
    ...
    s := strings.Join([]string{`&OldB{`,
        `C:` + strings.Replace(fmt2.Sprintf("%v", this.C), "OldC", "OldC", 1) + `,`,
        `F:` + strings.Replace(fmt2.Sprintf("%v", this.F), "OldC", "OldC", 1) + `,`,
        `XXX_unrecognized:` + fmt2.Sprintf("%v", this.XXX_unrecognized) + `,`,
        `}`,
    }, "")
...
func (m *C) MarshalTo(data []byte) (n int, err error) {
    ...
    if m.Field2 != nil {
        data[i] = 0x11
        i++
        i = encodeFixed64Unrecognized(data, i, uint64(math4.Float64bits(*m.Field2)))
    }
    if m.Field3 != nil {
        data[i] = 0x1a
        i++
    ...
    if m.Field4 != nil {
        data[i] = 0x21
        i++
        i = encodeFixed64Unrecognized(data, i, uint64(math4.Float64bits(*m.Field4)))
    }
    if len(m.Field5) > 0 {
        for _, b := range m.Field5 {
            data[i] = 0x2a
...
func (this *A) GoString() string {
    ...
    s := strings1.Join([]string{`&unrecognized.A{` + `Field1:` + valueToGoStringUnrecognized(this.Field1, "int64"), `B:` + fmt3.Sprintf("%#v", this.B), `XXX_unrecognized:` + fmt3.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
    return s
}
func (this *B) GoString() string {
    ...
    s := strings1.Join([]string{`&unrecognized.B{` + `C:` + fmt3.Sprintf("%#v", this.C), `D:` + fmt3.Sprintf("%#v", this.D), `F:` + fmt3.Sprintf("%#v", this.F), `XXX_unrecognized:` + fmt3.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
    return s
}
func (this *D) GoString() string {
    ...
    s := strings1.Join([]string{`&unrecognized.D{` + `Field1:` + valueToGoStringUnrecognized(this.Field1, "int64"), `XXX_unrecognized:` + fmt3.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
    return s
}
func (this *C) GoString() string {
    ...
    s := strings1.Join([]string{`&unrecognized.C{` + `Field2:` + valueToGoStringUnrecognized(this.Field2, "float64"), `Field3:` + valueToGoStringUnrecognized(this.Field3, "string"), `Field4:` + valueToGoStringUnrecognized(this.Field4, "float64"), `Field5:` + fmt3.Sprintf("%#v", this.Field5), `Field6:` + valueToGoStringUnrecognized(this.Field6, "int64"), `Field7:` + fmt3.Sprintf("%#v", this.Field7), `XXX_unrecognized:` + fmt3.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
    return s
}
func (this *OldA) GoString() string {
    ...
    s := strings1.Join([]string{`&unrecognized.OldA{` + `Field1:` + valueToGoStringUnrecognized(this.Field1, "int64"), `B:` + fmt3.Sprintf("%#v", this.B), `XXX_unrecognized:` + fmt3.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
    return s
}
func (this *OldB) GoString() string {
    ...
    s := strings1.Join([]string{`&unrecognized.OldB{` + `C:` + fmt3.Sprintf("%#v", this.C), `F:` + fmt3.Sprintf("%#v", this.F), `XXX_unrecognized:` + fmt3.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
    return s
}
...
func extensionToGoStringUnrecognized(e map[int32]dropbox_gogoprotobuf_proto4.Extension) string {
    if e == nil {
        return "nil"
    }
...
func (this *A) VerboseEqual(that interface{}) error {
    ...
    that1, ok := that.(*A)
    if !ok {
        return fmt4.Errorf("that is not of type *A")
    }
    if that1 == nil {
        if this == nil {
            return nil
        }
        return fmt4.Errorf("that is type *A but is nil && this != nil")
    } else if this == nil {
        return fmt4.Errorf("that is type *Abut is not nil && this == nil")
    }
    if this.Field1 != nil && that1.Field1 != nil {
        if *this.Field1 != *that1.Field1 {
            return fmt4.Errorf("Field1 this(%v) Not Equal that(%v)", *this.Field1, *that1.Field1)
        }
    } else if this.Field1 != nil {
        return fmt4.Errorf("this.Field1 == nil && that.Field1 != nil")
    } else if that1.Field1 != nil {
        return fmt4.Errorf("Field1 this(%v) Not Equal that(%v)", this.Field1, that1.Field1)
    }
    if len(this.B) != len(that1.B) {
        return fmt4.Errorf("B this(%v) Not Equal that(%v)", len(this.B), len(that1.B))
    }
    for i := range this.B {
        if !this.B[i].Equal(that1.B[i]) {
            return fmt4.Errorf("B this[%v](%v) Not Equal that[%v](%v)", i, this.B[i], i, that1.B[i])
        }
    }
...
func (this *B) VerboseEqual(that interface{}) error {
    ...
    that1, ok := that.(*B)
    if !ok {
        return fmt4.Errorf("that is not of type *B")
    }
    if that1 == nil {
        if this == nil {
            return nil
        }
        return fmt4.Errorf("that is type *B but is nil && this != nil")
    } else if this == nil {
        return fmt4.Errorf("that is type *Bbut is not nil && this == nil")
    }
    if !this.C.Equal(that1.C) {
        return fmt4.Errorf("C this(%v) Not Equal that(%v)", this.C, that1.C)
    }
    if !this.D.Equal(that1.D) {
        return fmt4.Errorf("D this(%v) Not Equal that(%v)", this.D, that1.D)
    }
    if !this.F.Equal(that1.F) {
        return fmt4.Errorf("F this(%v) Not Equal that(%v)", this.F, that1.F)
    }
    if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
        return fmt4.Errorf("XXX_unrecognized this(%v) Not Equal that(%v)", this.XXX_unrecognized, that1.XXX_unrecognized)
    }
...
func (this *D) VerboseEqual(that interface{}) error {
    ...
    that1, ok := that.(*D)
    if !ok {
        return fmt4.Errorf("that is not of type *D")
    }
    if that1 == nil {
        if this == nil {
            return nil
        }
        return fmt4.Errorf("that is type *D but is nil && this != nil")
    } else if this == nil {
        return fmt4.Errorf("that is type *Dbut is not nil && this == nil")
    }
    if this.Field1 != nil && that1.Field1 != nil {
        if *this.Field1 != *that1.Field1 {
            return fmt4.Errorf("Field1 this(%v) Not Equal that(%v)", *this.Field1, *that1.Field1)
...
func (this *C) VerboseEqual(that interface{}) error {
    ...
    that1, ok := that.(*C)
    if !ok {
        return fmt4.Errorf("that is not of type *C")
    }
    if that1 == nil {
        if this == nil {
            return nil
        }
        return fmt4.Errorf("that is type *C but is nil && this != nil")
    } else if this == nil {
        return fmt4.Errorf("that is type *Cbut is not nil && this == nil")
    }
    if this.Field2 != nil && that1.Field2 != nil {
        if *this.Field2 != *that1.Field2 {
            return fmt4.Errorf("Field2 this(%v) Not Equal that(%v)", *this.Field2, *that1.Field2)
        }
    } else if this.Field2 != nil {
        return fmt4.Errorf("this.Field2 == nil && that.Field2 != nil")
    } else if that1.Field2 != nil {
        return fmt4.Errorf("Field2 this(%v) Not Equal that(%v)", this.Field2, that1.Field2)
    }
    if this.Field3 != nil && that1.Field3 != nil {
        if *this.Field3 != *that1.Field3 {
            return fmt4.Errorf("Field3 this(%v) Not Equal that(%v)", *this.Field3, *that1.Field3)
        }
    } else if this.Field3 != nil {
        return fmt4.Errorf("this.Field3 == nil && that.Field3 != nil")
    } else if that1.Field3 != nil {
        return fmt4.Errorf("Field3 this(%v) Not Equal that(%v)", this.Field3, that1.Field3)
    }
    if this.Field4 != nil && that1.Field4 != nil {
        if *this.Field4 != *that1.Field4 {
            return fmt4.Errorf("Field4 this(%v) Not Equal that(%v)", *this.Field4, *that1.Field4)
        }
    } else if this.Field4 != nil {
        return fmt4.Errorf("this.Field4 == nil && that.Field4 != nil")
    } else if that1.Field4 != nil {
        return fmt4.Errorf("Field4 this(%v) Not Equal that(%v)", this.Field4, that1.Field4)
    }
    if len(this.Field5) != len(that1.Field5) {
        return fmt4.Errorf("Field5 this(%v) Not Equal that(%v)", len(this.Field5), len(that1.Field5))
    }
    for i := range this.Field5 {
        if !bytes.Equal(this.Field5[i], that1.Field5[i]) {
            return fmt4.Errorf("Field5 this[%v](%v) Not Equal that[%v](%v)", i, this.Field5[i], i, that1.Field5[i])
        }
    }
    if this.Field6 != nil && that1.Field6 != nil {
        if *this.Field6 != *that1.Field6 {
            return fmt4.Errorf("Field6 this(%v) Not Equal that(%v)", *this.Field6, *that1.Field6)
        }
    } else if this.Field6 != nil {
        return fmt4.Errorf("this.Field6 == nil && that.Field6 != nil")
    } else if that1.Field6 != nil {
        return fmt4.Errorf("Field6 this(%v) Not Equal that(%v)", this.Field6, that1.Field6)
    }
    if len(this.Field7) != len(that1.Field7) {
        return fmt4.Errorf("Field7 this(%v) Not Equal that(%v)", len(this.Field7), len(that1.Field7))
    }
    for i := range this.Field7 {
        if this.Field7[i] != that1.Field7[i] {
            return fmt4.Errorf("Field7 this[%v](%v) Not Equal that[%v](%v)", i, this.Field7[i], i, that1.Field7[i])
        }
    }
    if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
        return fmt4.Errorf("XXX_unrecognized this(%v) Not Equal that(%v)", this.XXX_unrecognized, that1.XXX_unrecognized)
...
func (this *OldA) VerboseEqual(that interface{}) error {
    ...
    that1, ok := that.(*OldA)
    if !ok {
        return fmt4.Errorf("that is not of type *OldA")
    }
    if that1 == nil {
        if this == nil {
            return nil
        }
        return fmt4.Errorf("that is type *OldA but is nil && this != nil")
    } else if this == nil {
        return fmt4.Errorf("that is type *OldAbut is not nil && this == nil")
    }
    if this.Field1 != nil && that1.Field1 != nil {
        if *this.Field1 != *that1.Field1 {
            return fmt4.Errorf("Field1 this(%v) Not Equal that(%v)", *this.Field1, *that1.Field1)
...
func (this *OldB) VerboseEqual(that interface{}) error {
    ...
    that1, ok := that.(*OldB)
    if !ok {
        return fmt4.Errorf("that is not of type *OldB")
    }
    if that1 == nil {
        if this == nil {
            return nil
        }
        return fmt4.Errorf("that is type *OldB but is nil && this != nil")
    } else if this == nil {
        return fmt4.Errorf("that is type *OldBbut is not nil && this == nil")
    }
    if !this.C.Equal(that1.C) {
        return fmt4.Errorf("C this(%v) Not Equal that(%v)", this.C, that1.C)
    }
...
func (this *OldC) VerboseEqual(that interface{}) error {
    ...
    that1, ok := that.(*OldC)
    if !ok {
        return fmt4.Errorf("that is not of type *OldC")
    }
    if that1 == nil {
        if this == nil {
            return nil
        }
        return fmt4.Errorf("that is type *OldC but is nil && this != nil")
    } else if this == nil {
        return fmt4.Errorf("that is type *OldCbut is not nil && this == nil")
    }
    if this.Field1 != nil && that1.Field1 != nil {
        if *this.Field1 != *that1.Field1 {
            return fmt4.Errorf("Field1 this(%v) Not Equal that(%v)", *this.Field1, *that1.Field1)
...
func UnrecognizedDescription() (desc *google_protobuf.FileDescriptorSet) {
    return &google_protobuf.FileDescriptorSet{File: []*google_protobuf.FileDescriptorProto{&google_protobuf.FileDescriptorProto{Name: func(v string) *string { return &v }("dropbox/gogoprotobuf/protobuf/google/protobuf/descriptor.proto"), Package: func(v string) *string { return &v }("google.protobuf"), Dependency: []string(nil), PublicDependency: []int32(nil), WeakDependency: []int32(nil), MessageType: []*google_protobuf.DescriptorProto{&google_protobuf.DescriptorProto{Name: func(v string) *string { return &v }("FileDescriptorSet"), Field: []*google_protobuf.FieldDescriptorProto{&google_protobuf.FieldDescriptorProto{Name: func(v string) *string { return &v }("file"), Number: func(v int32) *int32 { return &v }(1), Label: func(v google_protobuf.FieldDescriptorProto_Label) *google_protobuf.FieldDescriptorProto_Label {
        ...
        return &v
    }(9), TypeName: nil, Extendee: func(v string) *string { return &v }(".google.protobuf.FieldOptions"), DefaultValue: nil, Options: nil, XXX_unrecognized: []byte{}}}, Options: nil, SourceCodeInfo: nil, XXX_unrecognized: []byte{}}, &google_protobuf.FileDescriptorProto{Name: func(v string) *string { return &v }("unrecognized.proto"), Package: func(v string) *string { return &v }("unrecognized"), Dependency: []string{"dropbox/gogoprotobuf/gogoproto/gogo.proto"}, PublicDependency: []int32(nil), WeakDependency: []int32(nil), MessageType: []*google_protobuf.DescriptorProto{&google_protobuf.DescriptorProto{Name: func(v string) *string { return &v }("A"), Field: []*google_protobuf.FieldDescriptorProto{&google_protobuf.FieldDescriptorProto{Name: func(v string) *string { return &v }("Field1"), Number: func(v int32) *int32 { return &v }(2), Label: func(v google_protobuf.FieldDescriptorProto_Label) *google_protobuf.FieldDescriptorProto_Label {
        return &v
    }(1), Type: func(v google_protobuf.FieldDescriptorProto_Type) *google_protobuf.FieldDescriptorProto_Type {
        return &v
    }(3), TypeName: nil, Extendee: nil, DefaultValue: nil, Options: nil, XXX_unrecognized: []byte{}}, &google_protobuf.FieldDescriptorProto{Name: func(v string) *string { return &v }("B"), Number: func(v int32) *int32 { return &v }(1), Label: func(v google_protobuf.FieldDescriptorProto_Label) *google_protobuf.FieldDescriptorProto_Label {
        return &v
    }(3), Type: func(v google_protobuf.FieldDescriptorProto_Type) *google_protobuf.FieldDescriptorProto_Type {
        return &v
        ...
        return &v
    }(11), TypeName: func(v string) *string { return &v }(".unrecognized.C"), Extendee: nil, DefaultValue: nil, Options: nil, XXX_unrecognized: []byte{}}, &google_protobuf.FieldDescriptorProto{Name: func(v string) *string { return &v }("D"), Number: func(v int32) *int32 { return &v }(2), Label: func(v google_protobuf.FieldDescriptorProto_Label) *google_protobuf.FieldDescriptorProto_Label {
        return &v
    }(1), Type: func(v google_protobuf.FieldDescriptorProto_Type) *google_protobuf.FieldDescriptorProto_Type {
        return &v
    }(11), TypeName: func(v string) *string { return &v }(".unrecognized.D"), Extendee: nil, DefaultValue: nil, Options: nil, XXX_unrecognized: []byte{}}, &google_protobuf.FieldDescriptorProto{Name: func(v string) *string { return &v }("F"), Number: func(v int32) *int32 { return &v }(5), Label: func(v google_protobuf.FieldDescriptorProto_Label) *google_protobuf.FieldDescriptorProto_Label {
        return &v
    }(1), Type: func(v google_protobuf.FieldDescriptorProto_Type) *google_protobuf.FieldDescriptorProto_Type {
        return &v
        ...
        return &v
    }(1), TypeName: nil, Extendee: nil, DefaultValue: nil, Options: nil, XXX_unrecognized: []byte{}}, &google_protobuf.FieldDescriptorProto{Name: func(v string) *string { return &v }("Field3"), Number: func(v int32) *int32 { return &v }(3), Label: func(v google_protobuf.FieldDescriptorProto_Label) *google_protobuf.FieldDescriptorProto_Label {
        return &v
    }(1), Type: func(v google_protobuf.FieldDescriptorProto_Type) *google_protobuf.FieldDescriptorProto_Type {
        return &v
    }(9), TypeName: nil, Extendee: nil, DefaultValue: nil, Options: nil, XXX_unrecognized: []byte{}}, &google_protobuf.FieldDescriptorProto{Name: func(v string) *string { return &v }("Field4"), Number: func(v int32) *int32 { return &v }(4), Label: func(v google_protobuf.FieldDescriptorProto_Label) *google_protobuf.FieldDescriptorProto_Label {
        return &v
    }(1), Type: func(v google_protobuf.FieldDescriptorProto_Type) *google_protobuf.FieldDescriptorProto_Type {
        return &v
    }(1), TypeName: nil, Extendee: nil, DefaultValue: nil, Options: nil, XXX_unrecognized: []byte{}}, &google_protobuf.FieldDescriptorProto{Name: func(v string) *string { return &v }("Field5"), Number: func(v int32) *int32 { return &v }(5), Label: func(v google_protobuf.FieldDescriptorProto_Label) *google_protobuf.FieldDescriptorProto_Label {
        return &v
    }(3), Type: func(v google_protobuf.FieldDescriptorProto_Type) *google_protobuf.FieldDescriptorProto_Type {
        return &v
    }(12), TypeName: nil, Extendee: nil, DefaultValue: nil, Options: nil, XXX_unrecognized: []byte{}}, &google_protobuf.FieldDescriptorProto{Name: func(v string) *string { return &v }("Field6"), Number: func(v int32) *int32 { return &v }(6), Label: func(v google_protobuf.FieldDescriptorProto_Label) *google_protobuf.FieldDescriptorProto_Label {
        return &v
    }(1), Type: func(v google_protobuf.FieldDescriptorProto_Type) *google_protobuf.FieldDescriptorProto_Type {
        return &v
    }(3), TypeName: nil, Extendee: nil, DefaultValue: nil, Options: nil, XXX_unrecognized: []byte{}}, &google_protobuf.FieldDescriptorProto{Name: func(v string) *string { return &v }("Field7"), Number: func(v int32) *int32 { return &v }(7), Label: func(v google_protobuf.FieldDescriptorProto_Label) *google_protobuf.FieldDescriptorProto_Label {
        return &v
    }(3), Type: func(v google_protobuf.FieldDescriptorProto_Type) *google_protobuf.FieldDescriptorProto_Type {
        return &v
        ...
        return &v
    }(11), TypeName: func(v string) *string { return &v }(".unrecognized.OldC"), Extendee: nil, DefaultValue: nil, Options: nil, XXX_unrecognized: []byte{}}, &google_protobuf.FieldDescriptorProto{Name: func(v string) *string { return &v }("F"), Number: func(v int32) *int32 { return &v }(5), Label: func(v google_protobuf.FieldDescriptorProto_Label) *google_protobuf.FieldDescriptorProto_Label {
        return &v
    }(1), Type: func(v google_protobuf.FieldDescriptorProto_Type) *google_protobuf.FieldDescriptorProto_Type {
        return &v
        ...
        return &v
    }(3), TypeName: nil, Extendee: nil, DefaultValue: nil, Options: nil, XXX_unrecognized: []byte{}}, &google_protobuf.FieldDescriptorProto{Name: func(v string) *string { return &v }("Field2"), Number: func(v int32) *int32 { return &v }(2), Label: func(v google_protobuf.FieldDescriptorProto_Label) *google_protobuf.FieldDescriptorProto_Label {
        return &v
    }(1), Type: func(v google_protobuf.FieldDescriptorProto_Type) *google_protobuf.FieldDescriptorProto_Type {
        return &v
    }(1), TypeName: nil, Extendee: nil, DefaultValue: nil, Options: nil, XXX_unrecognized: []byte{}}, &google_protobuf.FieldDescriptorProto{Name: func(v string) *string { return &v }("Field3"), Number: func(v int32) *int32 { return &v }(3), Label: func(v google_protobuf.FieldDescriptorProto_Label) *google_protobuf.FieldDescriptorProto_Label {
        ...
        return &v
    }(9), TypeName: nil, Extendee: nil, DefaultValue: nil, Options: nil, XXX_unrecognized: []byte{}}, &google_protobuf.FieldDescriptorProto{Name: func(v string) *string { return &v }("Field6"), Number: func(v int32) *int32 { return &v }(6), Label: func(v google_protobuf.FieldDescriptorProto_Label) *google_protobuf.FieldDescriptorProto_Label {
        return &v
    }(1), Type: func(v google_protobuf.FieldDescriptorProto_Type) *google_protobuf.FieldDescriptorProto_Type {
        return &v
    }(3), TypeName: nil, Extendee: nil, DefaultValue: nil, Options: nil, XXX_unrecognized: []byte{}}, &google_protobuf.FieldDescriptorProto{Name: func(v string) *string { return &v }("Field7"), Number: func(v int32) *int32 { return &v }(7), Label: func(v google_protobuf.FieldDescriptorProto_Label) *google_protobuf.FieldDescriptorProto_Label {
