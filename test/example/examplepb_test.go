...
import time "time"
import gogoprotobuf_proto "dropbox/gogoprotobuf/proto"
...
import time2 "time"
import gogoprotobuf_proto1 "dropbox/gogoprotobuf/proto"
...
import gogoprotobuf_proto2 "dropbox/gogoprotobuf/proto"
...
import gogoprotobuf_proto3 "dropbox/gogoprotobuf/proto"
import testing9 "testing"

func TestAProto(t *testing.T) {
    popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
    p := NewPopulatedA(popr, false)
    data, err := gogoprotobuf_proto.Marshal(p)
    if err != nil {
        panic(err)
    }
    msg := &A{}
    if err := gogoprotobuf_proto.Unmarshal(data, msg); err != nil {
        panic(err)
    }
    for i := range data {
...
func BenchmarkAProtoMarshal(b *testing.B) {
    ...
    b.ResetTimer()
    for i := 0; i < b.N; i++ {
        data, err := gogoprotobuf_proto.Marshal(pops[i%10000])
        if err != nil {
            panic(err)
        }
        total += len(data)
...
func BenchmarkAProtoUnmarshal(b *testing.B) {
    ...
    for i := 0; i < 10000; i++ {
        data, err := gogoprotobuf_proto.Marshal(NewPopulatedA(popr, false))
        if err != nil {
            panic(err)
        }
        datas[i] = data
    ...
    for i := 0; i < b.N; i++ {
        ...
        if err := gogoprotobuf_proto.Unmarshal(datas[i%10000], msg); err != nil {
            panic(err)
        }
    }
    b.SetBytes(int64(total / b.N))
...
func BenchmarkBProtoUnmarshal(b *testing.B) {
    ...
    datas := make([][]byte, 10000)
    for i := 0; i < 10000; i++ {
        data, err := gogoprotobuf_proto.Marshal(NewPopulatedB(popr, false))
        if err != nil {
            panic(err)
        }
        datas[i] = data
...
func BenchmarkCProtoUnmarshal(b *testing.B) {
    ...
    datas := make([][]byte, 10000)
    for i := 0; i < 10000; i++ {
        data, err := gogoprotobuf_proto.Marshal(NewPopulatedC(popr, false))
        if err != nil {
            panic(err)
        }
        datas[i] = data
...
func BenchmarkUProtoUnmarshal(b *testing.B) {
    ...
    datas := make([][]byte, 10000)
    for i := 0; i < 10000; i++ {
        data, err := gogoprotobuf_proto.Marshal(NewPopulatedU(popr, false))
        if err != nil {
            panic(err)
        }
        datas[i] = data
...
func BenchmarkEProtoUnmarshal(b *testing.B) {
    ...
    datas := make([][]byte, 10000)
    for i := 0; i < 10000; i++ {
        data, err := gogoprotobuf_proto.Marshal(NewPopulatedE(popr, false))
        if err != nil {
            panic(err)
        }
        datas[i] = data
...
func TestAProtoText(t *testing2.T) {
    ...
    p := NewPopulatedA(popr, true)
    data := gogoprotobuf_proto1.MarshalTextString(p)
    msg := &A{}
    if err := gogoprotobuf_proto1.UnmarshalText(data, msg); err != nil {
        panic(err)
    }
    if err := p.VerboseEqual(msg); err != nil {
        t.Fatalf("%#v !VerboseProto %#v, since %v", msg, p, err)
...
func TestAProtoCompactText(t *testing2.T) {
    popr := math_rand2.New(math_rand2.NewSource(time2.Now().UnixNano()))
    p := NewPopulatedA(popr, true)
    data := gogoprotobuf_proto1.CompactTextString(p)
    msg := &A{}
    if err := gogoprotobuf_proto1.UnmarshalText(data, msg); err != nil {
        panic(err)
    }
...
func TestASize(t *testing5.T) {
    ...
    p := NewPopulatedA(popr, true)
    size2 := gogoprotobuf_proto2.Size(p)
    data, err := gogoprotobuf_proto2.Marshal(p)
    if err != nil {
        panic(err)
    }
    size := p.Size()
    ...
    size3 := gogoprotobuf_proto2.Size(p)
    if size3 != size {
...
func TestAVerboseEqual(t *testing8.T) {
    ...
    p := NewPopulatedA(popr, false)
    data, err := gogoprotobuf_proto3.Marshal(p)
    if err != nil {
        panic(err)
    }
    msg := &A{}
    if err := gogoprotobuf_proto3.Unmarshal(data, msg); err != nil {
        panic(err)
    }
    if err := p.VerboseEqual(msg); err != nil {
...
//These tests are generated by dropbox/gogoprotobuf/plugin/testgen
